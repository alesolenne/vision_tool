...
tmux new-session -s demo -n alessandro -d
...
tmux send-keys -t 1 "roslaunch vision_tool demo_transform.launch" C-m
sleep 1.0
...
tmux send-keys -t 4 "roslaunch visp_megapose megapose_client_command.launch" C-m
sleep 1.0
tmux send-keys -t 2 "roslaunch visp_megapose command.launch" C-m
